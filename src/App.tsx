    ...
    >
      ...
      <main className={`w-full max-w-7xl mx-auto flex-1 flex flex-col justify-between px-2 md:px-6 py-1 md:py-3 relative z-10 overflow-hidden ${shakeClass}`}>
        ...
        <div className="flex md:hidden flex-col w-full">
          <div className="grid grid-cols-3 gap-1.5 w-full max-w-md mx-auto px-1 py-1.5 bg-slate-950/40 rounded-2xl border border-white/5 backdrop-blur-sm shadow-inner">
        ...
        {/* =========================================================================
            DESKTOP LAYOUT (md:): Opponents
            ========================================================================= */}
        <div className="hidden md:flex w-full justify-center pt-1">
        ...
        <div className="w-full flex items-center justify-between my-auto relative">
          ...
          <div className="hidden md:flex w-28 lg:w-36 justify-start">
          ...
          <div className="hidden md:flex w-28 lg:w-36 justify-end">
